...
const findScripts = async () => (await promises_1.default.readdir(paths_1.SCRIPTS_DIR)).map((f) => ({ path: path_1.default.join(paths_1.SCRIPTS_DIR, f), name: path_1.default.parse(f).name }));
