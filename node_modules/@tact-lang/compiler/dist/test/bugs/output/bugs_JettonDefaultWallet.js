...
class JettonDefaultWallet {
    ...
    async send(provider, via, args, message) {
        let body = null;
        if (message && typeof message === 'object' && !(message instanceof ton_core_1.Slice) && message.$$type === 'TokenTransfer') {
            body = (0, ton_core_1.beginCell)().store(storeTokenTransfer(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof ton_core_1.Slice) && message.$$type === 'TokenTransferInternal') {
            body = (0, ton_core_1.beginCell)().store(storeTokenTransferInternal(message)).endCell();
        }
        if (message && typeof message === 'object' && !(message instanceof ton_core_1.Slice) && message.$$type === 'TokenBurn') {
            body = (0, ton_core_1.beginCell)().store(storeTokenBurn(message)).endCell();
        }
        if (body === null) {
